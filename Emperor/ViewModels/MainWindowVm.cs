...
namespace Emperor.ViewModels
{
	public sealed class MainWindowVm : INotifyPropertyChanged
	{
		...
		public bool IncreaseSpriteLimitsIsChecked { get; set; }
		...
		public string IncreaseSpriteLimitCheckboxText
		{
			get => increaseSpriteLimitCheckboxText;
			private set => setField(ref increaseSpriteLimitCheckboxText, value, "IncreaseSpriteLimitCheckboxText");
		}
		...
		public ICommand IncreaseSpriteLimitsHelpEvent { get; } = new RelayCommand(_ => Instance.IncreaseSpriteLimitsHelpButtonClickedEventHandler?.Invoke());
		...
		private string increaseSpriteLimitCheckboxText;
		...
		public event VoidReturnNoArgumentsEvent IncreaseSpriteLimitsHelpButtonClickedEventHandler;
		...
		{
			WindowTitle = "Emperor Resolution Customiser";
			...
			PatchEngTextCheckboxText = "Patch EmperorText.eng";
			ResizeImagesCheckboxText = "Resize Images";
			StretchImagesCheckboxText = "Stretch menu images to fit window";
			IncreaseSpriteLimitCheckboxText = "Double Sprite Limits (warning: see ?)";
			SelectExeButtonText = "Select Emperor.exe";
