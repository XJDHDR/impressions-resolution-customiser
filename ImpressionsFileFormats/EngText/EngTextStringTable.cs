...
namespace ImpressionsFileFormats.EngText
{
	public readonly struct EngTextStringTable
	{
		...
		/// <summary>
		/// Populate this struct's Strings array from a BinaryReader.
		/// </summary>
		/// <param name="BinaryReader">BinaryReader containing the String Table's binary data.</param>
		/// <param name="Messages">A StringBuilder that any error or warning messages generated by the program will be written to.</param>
		/// <param name="NextGroupOffset">The start position of the Strings that are part of the next Group.</param>
		/// <param name="EmptyArray">
		///		Empty array that the StringsInGroup array will be assigned to if the group has 0 strings in it.
		///		Used to avoid excessive heap allocations.
		/// </param>
		/// <param name="Header">The Header data for the EngText file that is being read.</param>
		/// <param name="GroupIndex">The GroupIndex data for the group that is currently being read.</param>
		/// <param name="NumStringsRead">The number of strings read from this group will be appended to this field.</param>
		/// <param name="NumWordsRead">The number of words read from this group will be appended to this field.</param>
		/// <param name="WasSuccessful">True if the constructor successfully read all the strings for this group. False if an error occurred.</param>
		...
		/// <summary>
		/// Used to read bytes from a Stream until a NULL is encountered.
		/// </summary>
		/// <param name="BinaryReader">A BinaryReader pointing to the string that needs to be read.</param>
		/// <param name="Header">The Header data for the EngText file that is being read.</param>
		/// <param name="NumStringsRead">The number of strings read from this group will be appended to this field.</param>
		/// <param name="NumWordsRead">The number of words read from this group will be appended to this field.</param>
		/// <param name="ExcessNullsRead">This value is incremented when a string is followed by more than 1 NULL.</param>
		/// <param name="ReadString">The string that was read from the binary data.</param>
