			...
			switch ((byte)ExeAttributes.SelectedExeLangAndDistrib)
			{
				case 1:         // English GOG version
					ResHexOffsetTable = new ResHexOffsetTable
					{
						...
						{
							0xA3,0xF4,0xDF,0x60,0x01,		// mov 0x160DFF4, eax
							0xE8,0xA6,0x4F,0xFD,0xFF,		// call sub_1ACF50
							0xA1,0xF4,0xDF,0x60,0x01,		// mov eax, 0x160DFF4
							0x8B,0x0D,0x34,0xFF,0x0D,0x01,	// mov ecx, 0x10DFF34
							0x6A,0x00,						// push 0
							0x6A,0x00,
							0x6A,0x00,
							0x6A,0x00,						// push 0				- Sets the vertical position??
							0x51,							// push ecx				- Sets the horizontal position??
							0x50,							// push eax
							0xB9,0xE8,0xEB,0x2A,0x01,		// mov ecx, offset unk_12AEBE8
							0xE8,0x87,0x4F,0xFD,0xFF,		// call sub_1ACF50
							0xE9,0xB8,0xFB,0xF3,0xFF		// jmp loc_117B86		- Jump back to the byte after our jump into this injected code as we are done here.
						},
