...
// https://github.com/XJDHDR/impressions-resolution-customiser/zeus_and_poseidon/non-UI_code/Crc32/LICENSE
//
...
namespace Zeus_and_Poseidon.non_UI_code.Crc32
{
	...
	public static class SliceBy16
	{
		...
		public static uint Crc32(int Offset, byte[] Data) =>
			Crc32(Offset, Data, Data.Length - Offset, 0);
		...
		public static uint Crc32(int Offset, byte[] Data, uint PreviousCrc32) =>
			Crc32(Offset, Data, Data.Length - Offset, PreviousCrc32);
