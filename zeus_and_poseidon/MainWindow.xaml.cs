...
namespace Zeus_and_Poseidon
{
	...
	public partial class MainWindow
	{
		...
		private string zeusExeDirectory;
		...
		private void GenerateExe_Click(object Sender, RoutedEventArgs EventArgs)
		{
			...
			else
			{
				...
				ZeusMakeChanges._ProcessZeusExe(zeusExeDirectory, Convert.ToUInt16(resWidthPreTests),
		...
		private void SelectExe_Click(object Sender, RoutedEventArgs EventArgs)
		{
			...
			if (openFileDialog.ShowDialog() == true)
			{
				...
				zeusExeDirectory = pathStringBuilder.ToString();
			}
		}
		...
		private void ApplyAnimationFix_Help_Click(object Sender, RoutedEventArgs E)
		{
			string[] messageLines = {
				"Apply Animation Fixes:",
				"This tickbox tells this program to fix Zeus' slow gods and urchin quay animations on modern CPUs if enabled."
			};
			MessageBox.Show(string.Join(Environment.NewLine, messageLines));
		}
